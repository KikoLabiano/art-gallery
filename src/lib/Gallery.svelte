...
<button class:anterior={true} disabled={cuadroActual === 0} on:click={() => cambiarCuadro(-1)}>{`<`}</button>
...
<button disabled={cuadroActual === cuadros.length - 1} on:click={() => cambiarCuadro(1)}>></button>
